      ...
      <div class="row">
        ...
        <!-- <div class="col-sm-4">
          <div class="card">
            ...
            <a href="https://www.edfthai.org/?page=our_works&id=38" title="eduation">
              <button type="button" class="btn btn-outline-secondary">Read more</button>
            </a>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card">
            <img
              src="https://www.thaihealth.or.th/data/content/2017/09/38758/cms/newscms_thaihealth_c_aegiklpst789.jpg"
              alt="Smiley face"
              width="500"
              height="200"
            />
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-3">
              <div class="widget subscribe no-box">
                ...
                <p>เว็บไซต์เพื่อการบริจาค โปร่งใส ตรวจสอบได้ ปลอดภัย 100%</p>
              </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
              <div class="widget no-box">
                ...
                <ul class="thumbnail-widget">
                  ...
                  <li>
                    <div class="thumb-content">
                      <a href="#.">โครงการยอดฮิต</a>
                    </div>
                  </li>
                  <li>
                    <div class="thumb-content">
                      <a href="#.">ประเภทโครงการ</a>
                    </div>
                  </li>
                  <li>
                    <div class="thumb-content">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
              <div class="widget no-box">
                ...
                <p>
                  <a href="mailto:info@domain.com" title="glorythemes">DoWeb.com</a>
                </p>
                <p>Tel : 1234567890</p>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-center">
              <p>Copyright DoWeb © 2019. All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>
