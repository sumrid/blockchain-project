...
docker exec \
	...
	-C mychannel-1 -n $CC_NAME -l golang -v 1.0 \
...
# 	peer chaincode instantiate \
# 	-o orderer.example.com:7050 \
# 	-C mychannel-2 -n $CC_NAME -l golang -v 1.0 \
...
docker exec \
	...
	-o orderer.example.com:7050 \
	-C mychannel-1 -n $CC_NAME -c '{"Args":["createProject","p_01","ช่วยเหลือโรงเรียนห่างไกล","avaliable","0", "sumrid.k", "09-08-2019:13:54:44", "15-08-2019:13:54:44"]}' \
...
docker exec \
	...
	cli peer chaincode invoke \
	-o orderer.example.com:7050 \
	-C mychannel-1 -n $CC_NAME -c '{"Args":["createProject","p_02","ทุนการศึกษา","avalidable", "0", "34d91a1d6ef", "09-08-2019:13:54:44", "15-08-2019:13:54:44"]}' \
	--peerAddresses peer0.org1.example.com:7051 \
	--peerAddresses peer0.org2.example.com:7051
...
# 	cli peer chaincode invoke \
# 	-o orderer.example.com:7050 \
# 	-C mychannel-2 -n $CC_NAME -c '{"Args":["createWallet","hi","9000","Sumrid"]}' \
# 	--peerAddresses peer0.org2.example.com:7051 \
