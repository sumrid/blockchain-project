...
docker exec \
	...
	-o orderer.example.com:7050 \
	-C $CHANNEL -n $CC_NAME -c '{"Args":["createProject","p_01","แมวจรจัด","open","0", "i8sB6Q7smBeFNcaE72Fu9W2Kd7H3", "2019-01-20T13:54:44Z", "2019-07-01T13:54:44Z", "5iTN33yflbO6uWFhpAJox6FbR5o2", "100000"]}' \
...
docker exec \
	...
	cli peer chaincode invoke \
	-o orderer.example.com:7050 \
	-C $CHANNEL -n $CC_NAME -c '{"Args":["createProject","p_02","ทุนการศึกษา","open", "0", "i8sB6Q7smBeFNcaE72Fu9W2Kd7H3", "2019-01-20T13:54:44Z", "2020-01-01T13:54:44Z", "user1", "50000"]}' \
	--peerAddresses peer0.org1.example.com:7051 \
	--peerAddresses peer0.org2.example.com:7051 \
    --peerAddresses peer0.org3.example.com:7051
