...
docker exec \
	...
	-o orderer.example.com:7050 \
	-C mychannel-1 -n $CC_NAME -c '{"Args":["createProject","p_01","ช่วยเหลือโรงเรียนห่างไกล","open","0", "sumrid.k", "09-08-2019:13:54:44", "15-08-2019:13:54:44"]}' \
...
docker exec \
	...
	cli peer chaincode invoke \
	-o orderer.example.com:7050 \
	-C mychannel-1 -n $CC_NAME -c '{"Args":["createProject","p_02","ทุนการศึกษา","open", "0", "34d91a1d6ef", "09-08-2019:13:54:44", "10-08-2019:13:54:44"]}' \
	--peerAddresses peer0.org1.example.com:7051 \
	--peerAddresses peer0.org2.example.com:7051
